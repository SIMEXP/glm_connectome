...
files_in = niak_grab_fmri_preprocess([root_path 'blind_fmri_preprocess_bascglm_20140405/'],opt_g);

%%%%%%%%%%%%%
%% Options %%
%%%%%%%%%%%%%
opt.folder_out = [root_path 'blind_region_growing_bascglm_20140405/']; % Where to store the results

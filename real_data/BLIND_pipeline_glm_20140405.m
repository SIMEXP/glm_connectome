% Run the multiscale GLM-connectome pipeline (with group FDR) on the BLIND dataset.
...
%% Options 
%%%%%%%%%%%%
opt.folder_out = '/gs/scratch/porban/bascglm/results/blind_glm_bascglm_20140405'; % Where to store the results

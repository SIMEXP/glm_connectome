...
files_in = niak_grab_stability_rest('/gs/scratch/porban/bascglm/blind_basc_bascglm_20141101',opt_g_basc);
...
%% Options 
%%%%%%%%%%%%
opt.folder_out = '/gs/scratch/porban/bascglm/results/blind_glm_BH_all_bascglm_20141101'; % Where to store the results

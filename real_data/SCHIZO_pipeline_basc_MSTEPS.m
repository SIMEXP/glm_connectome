...
files_in = niak_grab_region_growing([root_path 'cobre_region_growing_bascglm_20140405/rois/']);

%%%%%%%%%%%%%
%% Options %%
%%%%%%%%%%%%%

opt.folder_out = [root_path 'cobre_basc_msteps_bascglm_20141101/']; % Where to store the results
...
opt.scales_maps = [10 7 7;...
    ...
    120 108	114;...
    210	189	199;...
    270	324	328]; % The scales that will be used to generate the maps of brain clusters and stability

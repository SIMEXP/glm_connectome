...
%% Output
folder_out = '/gs/scratch/pbellec/glm_connectome/simu_multiscale_xp6b/';
%folder_out = '/home/pbellec/database/glm_connectome/simu_multiscale_xp6b/';
type_fdr = 'LSL_sym';
nb_samps = 10;
...
for num_s = 1:nb_samps
    ...
    for num_alpha2 = 1:length(param.alpha2)
        ...
        num_seed = num_seed+1;        
        pipe = psom_add_job(pipe,name_job,'glmc_brick_simu_nbs',in,out,opt);
    end
    end
    end
end
